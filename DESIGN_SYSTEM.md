...
| Serif  | DM Serif Display, locally bundled        |
| Sans   | DM Sans, locally bundled                 |
...
- Layouts are checked at 375, 768, 1024, and 1440px. Use native input and text scaling; avoid horizontal page overflow.
